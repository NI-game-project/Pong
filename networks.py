...
class Hypernetwork_PONG(keras.Model):
    ...
    def __init__(self, name):
        ...
        self.w4_dense_1 = Dense(100, activation=self.Activation, kernel_initializer=uniform6, bias_initializer=bias_init)
        self.batch_norm_w4 = tf.keras.layers.BatchNormalization(momentum=0.98)
        self.w4_dense_2 = Dense(321, activation=self.Activation, kernel_initializer=uniform7, bias_initializer=bias_init)
        ...
        self.w6_dense_1 = Dense(100, activation=self.Activation, kernel_initializer=uniform6, bias_initializer=bias_init)
        self.batch_norm_w6 = tf.keras.layers.BatchNormalization(momentum=0.98)
        self.w6_dense_2 = Dense(257, activation=self.Activation, kernel_initializer=uniform7, bias_initializer=bias_init)
        ...
        self.w8_dense_1 = Dense(100, activation=self.Activation, kernel_initializer=uniform6, bias_initializer=bias_init)
        self.batch_norm_w8 = tf.keras.layers.BatchNormalization(momentum=0.98)
        self.w8_dense_2 = Dense(257, activation=self.Activation, kernel_initializer=uniform7, bias_initializer=bias_init)
